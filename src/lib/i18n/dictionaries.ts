...
export const dictionary = {
  ...
  "tasks.assignee": { th: "ผู้รับผิดชอบ", en: "Assignees" },
  "tasks.addAssignee": { th: "+ เพิ่มผู้รับผิดชอบ", en: "+ Add an assignee" },
  "tasks.everyoneAssigned": {
    th: "เพิ่มครบทุกคนแล้ว",
    en: "Everyone has been added",
  },
  "tasks.removeAssignee": { th: "เอาออกจากงาน", en: "Remove from the task" },
  ...
  "trips.people": { th: "ผู้เดินทาง", en: "Travellers" },
  "trips.addPerson": { th: "+ เพิ่มผู้เดินทาง", en: "+ Add a traveller" },
  "trips.everyoneAdded": {
    th: "เพิ่มครบทุกคนแล้ว",
    en: "Everyone has been added",
  },
  "trips.removePerson": { th: "เอาออกจากรายชื่อ", en: "Remove from the trip" },
  ...
  "customers.source.fieldVisit": { th: "ออกไปเจอเอง", en: "Field visit" },
  "customers.source.enquiryEmail": { th: "อีเมลเข้ามา", en: "Email enquiry" },
  "customers.source.enquiryPhone": { th: "โทรเข้ามา", en: "Phone enquiry" },
  "customers.source.enquiryLine": { th: "ทัก LINE เข้ามา", en: "LINE enquiry" },
  "customers.source.enquiryWeb": { th: "เว็บไซต์ / ฟอร์ม", en: "Website form" },
  "customers.source.event": { th: "งานอีเวนต์ / ออกบูธ", en: "Event or booth" },
  "customers.source.referral": { th: "มีคนแนะนำต่อ", en: "Referral" },
  "customers.source": { th: "ช่องทางที่เข้ามา", en: "How they reached us" },
  "customers.sourceHint": {
    th: "ใครติดต่อใครก่อน — ใช้ตอบทีมการตลาดว่างานเข้ามาจากทางไหน",
    en: "Who approached whom — this is what the marketing counts are read off.",
  },
  "customers.filterSource": { th: "กรองตามช่องทาง", en: "Filter by channel" },
  "customers.allSources": { th: "ทุกช่องทาง", en: "All channels" },
  "customers.firstContactedAt": { th: "เข้ามาเมื่อ", en: "First contact" },
  "customers.firstContactedAtHint": {
    th: "วันที่ติดต่อกันครั้งแรก ถ้าไม่ระบุจะใช้วันที่บันทึก",
    en: "The day it actually arrived. Left blank, the day it was recorded is used.",
  },
  "customers.recordedOn": { th: "วันที่บันทึก", en: "Recorded" },

  "customers.visits": { th: "การเดินทางมาที่นี่", en: "Visits here" },
  "customers.exportCsv": { th: "ดาวน์โหลด CSV", en: "Download CSV" },
  "customers.exportHint": {
    th: "เปิดด้วย Excel ได้เลย ไฟล์จะตรงกับตัวกรองที่เลือกอยู่",
    en: "Opens in Excel. The file matches the filters currently applied.",
  },

  "trips.customerPin": { th: "ลูกค้าบนแผนที่", en: "Customer on the map" },
  "trips.noCustomerPin": {
    th: "ไม่ได้ไปหาลูกค้าบนแผนที่",
    en: "Not a visit to a pin on the map",
  },
  "trips.customerPinHint": {
    th: "เลือกแล้วระบบจะเติมชื่อสถานที่ ที่อยู่ และพิกัดให้ แก้ทีหลังได้",
    en: "Picking one fills in the place, address and coordinates below. Still editable.",
  },
  "trips.openCustomerPin": { th: "ดูบนแผนที่ลูกค้า", en: "See on the customer map" },

  "customers.leads": { th: "รายชื่อลูกค้า", en: "Lead list" },
  "customers.leadsSubtitle": {
    th: "ทุกรายบนแผนที่ เรียงตามวันที่เข้ามา — สำหรับส่งต่อทีมการตลาด",
    en: "Every lead on the board, newest first — the view marketing reads.",
  },
  "customers.openMap": { th: "เปิดแผนที่", en: "Open the map" },
  "customers.openLeads": { th: "ดูเป็นรายชื่อ", en: "See the list" },
  "customers.totalLeads": { th: "ลูกค้าทั้งหมด", en: "Leads in total" },
  "customers.inboundLeads": { th: "ติดต่อเข้ามาเอง", en: "Came to us" },
  "customers.outboundLeads": { th: "เราออกไปเจอ", en: "We went to them" },
  "customers.byChannel": { th: "แยกตามช่องทาง", en: "By channel" },
  "customers.byStatus": { th: "แยกตามสถานะ", en: "By status" },
  "customers.place": { th: "สถานที่", en: "Place" },
  "customers.noPlaceName": { th: "ไม่ได้ตั้งชื่อจุด", en: "Unnamed place" },
  "customers.showAll": { th: "ดูทั้งหมด", en: "Show all" },
  ...
  "customers.toggleTools": { th: "เครื่องมือแผนที่", en: "Map tools" },
  "customers.showTrips": { th: "คนออกนอกสถานที่", en: "People off-site" },
  "customers.openTrip": { th: "ดูรายละเอียดภารกิจ", en: "Open the trip" },
